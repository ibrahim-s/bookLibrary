...
addon_info = {
	...
	"addon_name" : "myArabicLibrary",
	# Add-on summary, usually the user visible name of the addon.
	# Translators: Summary for this add-on to be shown on installation and add-on information.
	"addon_summary" : _("My Arabic Library"),
	# Add-on description
...
And as always you can change this command via: nvda menu> preferences>input gestures> my arabic library."""),
	# version
...
pythonSources = [os.path.join("addon", "globalPlugins", "myArabicLibrary", "*.py"), ]
